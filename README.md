# DigitalNotes
Υπηρεσία δημιουργίας ψηφιακών σημειώσεων. Δημιουργήθηκε στα πλάισια εργασίας του προπτυχιακόυ μαθήματος "Πληροφοριακά Συστήματα" του 6ου εξαμήνου του τμήματος Ψηφιακών Συστημάτων του Πανεπηστημίου Πειραιώς
